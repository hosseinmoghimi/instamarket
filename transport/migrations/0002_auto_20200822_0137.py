    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(choices=[('وانت', 'وانت'), ('اتوبوس', 'اتوبوس'), ('تاکسی', 'تاکسی')], default='تاکسی', max_length=50, verbose_name='نوع وسیله ')),
                ('quantity', models.IntegerField(default=1, verbose_name='تعداد')),
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='date_added')),
                ('date_needed', models.DateTimeField(verbose_name='date_needed')),
