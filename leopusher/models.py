...
class PusherChannel(models.Model):
    ...
    channel_name=models.CharField(verbose_name='channel_name',max_length=20,choices=PusherChannelNameEnum.choices,default=PusherChannelNameEnum.NONE) 
...
class ProfileChannelEvent(models.Model):
    ...
    def __str__(self):
        return f'{self.profile.name()} : {self.channel_event.title}'
